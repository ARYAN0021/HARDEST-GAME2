...
function setup() {
  ...
  iron.scale=0.6;
  iron.setCollider("rectangle",0,0,80,240);
  iron.debug=false;
  ...
  gameover=createSprite(290,160,10,10);
  gameover.addImage(gameImage);
 gameover.scale=0.7;
  
  
  invisibleGround=createSprite(300,440,600,10);
...
function enemy(){
  ...
  vilin=createSprite(600,380,10,10);
  ...
  if(World.frameCount%70===0){
    ...
    if(r===1){
      stones.addImage(stone1)
       ...
       stones.scale=0.2
       stones.velocityX = -6 
       stones.y=Math.round(random(100,500))
       stones.lifetime=150;
